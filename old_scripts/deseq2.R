...
inputDir  <- args[1]
outputDir <- args[2]
inputDir  <- "Wsl$/Ubuntu/root/nextflow_workflow/output/counts"
outputDIr <- "wsl$/Ubuntu/root/nextflow_workflow/output/deseq2"
inputDir <- "\\\\wsl.localhost\\Ubuntu\\root\\nextflow_workflow\\output\\counts"
...
coldata <- read.table("\\\\wsl.localhost\\Ubuntu\\root\\nextflow_workflow\\output\\deseq2\\samples_for_deseq2.txt")
